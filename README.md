...
```PowerShell
java -cp target/kafka-case-1.0-SNAPSHOT-jar-with-dependencies.jar CustomConsumer
```
...
```PowerShell
java -cp target/kafka-case-1.0-SNAPSHOT-jar-with-dependencies.jar CustomProducer
```
